...
ax.fig.suptitle('Distribuição de Frequência - Altura', fontsize=18)
ax.set_xlabel('Metros', fontsize=14)
ax

ax = sns.displot(dados.Altura, kde = True)
ax.figure.set_size_inches(12,6)
ax.fig.suptitle('Distribuição de Frequência - Altura - KDE', fontsize=18)
ax.set_xlabel('Metros', fontsize=14)
ax
...
ax = sns.distplot(dados.Idade,
                 ...
                 kde_kws = {'cumulative': True},
                  bins = 10)
ax.figure.set_size_inches(12,6)
#ax.fig.suptitle('Distribuição de Frequência Acumulada', fontsize=18)
...
ax = sns.boxplot( x = 'Renda', y = 'Sexo',data = dados.query('Renda < 4000'), orient = 'h')
ax.figure.set_size_inches(12,4)
ax.set_title('Renda', fontsize=18)
ax.set_xlabel('Valores', fontsize=14)
